...
const EXAMPLE_RESULT: AnalysisResult = {
  ...
  performance_breakdown: [
    { metric: 'Hook Rate', meaning: 'retenção nos 3 primeiros segundos', level: 'otimo', note: 'Bom — o gancho visual prende a atenção logo de início.' },
    { metric: 'Hold Rate', meaning: 'retenção até o final', level: 'bom', note: 'Cai depois dos 8 segundos, quando o ritmo desacelera.' },
    { metric: 'CTR', meaning: 'taxa de cliques', level: 'bom', note: 'Tende a ficar mediano — falta uma chamada clara mais cedo.' },
    { metric: 'CPC', meaning: 'custo por clique', level: 'bom', note: 'Deve subir se a chamada para ação não for antecipada.' },
    { metric: 'CPM', meaning: 'custo por mil impressões', level: 'otimo', note: 'Neutro — não há elementos que penalizem o alcance.' },
    { metric: 'CPA', meaning: 'custo por aquisição', level: 'bom', note: 'Depende de reforçar a prova social antes da chamada final.' },
    { metric: 'ROAS', meaning: 'retorno sobre o investimento em mídia', level: 'bom', note: 'Potencial moderado até a chamada ser antecipada.' },
  ],
